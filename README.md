...
### Core Focus
- **Adaptive Learning Systems** – Using contextual machine learning (e.g., Thompson Sampling) to personalize resource recommendations
- **Learning Analytics** – Understanding *why* students choose particular resources and what makes them effective
- **Generative AI in Education** – How to help students critically evaluate and use AI-generated explanations, examples, and code
- **Human-Centered Machine Learning** – Building systems students and instructors trust and understand
...
**Tech:** Data Systems · ETL Pipelines · Database Design · Educational Analytics · Large-Scale Data Management
...
This means:
- ✅ **Evidence-based decisions** – Empirical studies inform system design
- ✅ **Transparent algorithms** – Students and instructors understand why recommendations are made
- ✅ **Human control** – Technology augments instructor judgment, not replaces it
- ✅ **Real-world validation** – Research happens in actual courses with actual learners
- ✅ **Ethical AI** – Careful attention to fairness, privacy, and responsible technology use
- ✅ **Secure systems** – User data protection and security by design

---

## 📊 By The Numbers

- 🎓 **10+ years** in technology and education
- 🌍 **3 continents** – Research and work across Nigeria, Fiji, and USA
...
| Link | Purpose |
|------|---------|
| 🌐 [Academic Portfolio](https://awwal-badru.github.io) | CV, publications, research details |
| 📊 [Google Scholar](https://scholar.google.com/citations?user=DW7LA8sAAAAJ&hl) | Research papers & citations |
| 🔬 [ResearchGate](https://www.researchgate.net/profile/Awwal-Badru) | Research collaboration & preprints |
| 💼 [LinkedIn](https://www.linkedin.com/in/awwal-b-389887198) | Professional background |
| 📧 [Email](mailto:lobadru@crimson.ua.edu) | Direct contact |
...
**[→ Let's connect and build something meaningful!](mailto:lobadru@crimson.ua.edu)**
...
1. **Advances adaptive systems** – Longitudinal studies showing when and how personalization helps, across different courses and learner populations
2. **Investigates human-centered ML** – How to build transparent, trustworthy machine learning systems for education
3. **Develops open research infrastructure** – Tools and platforms that enable other researchers and educators to deploy and study adaptive interventions
